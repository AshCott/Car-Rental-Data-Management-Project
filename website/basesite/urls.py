...
url('recommended_car/', views.recommended_car, name='recommended_car'), # reccomended car url, shows on localhost:8000/recommended_car/
url('customer/(\d+)', views.customer, name='customer'), # customer url, shows on localhost:8000/customer/
...
url('customer_details/(\d+)', views.customer_details, name='customer_details') # search url, shows on localhost:8000/customer_details/
]
